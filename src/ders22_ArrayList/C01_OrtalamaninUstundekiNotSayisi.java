...
public class C01_OrtalamaninUstundekiNotSayisi {
    public static void main(String[] args) {
        ...
        // sinif sayisini, sinif ortalamasini ve kac kisinin ortalmanin ustunde not aldigini yazdirin


        List<Double> notlar = ogrenciNotListesi();
    ...
    public static List<Double> ogrenciNotListesi(){
