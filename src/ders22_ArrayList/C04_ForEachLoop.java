...
public class C04_ForEachLoop {
    public static void main(String[] args) {
        ...
        // bu array'deki tum elementleri toplayalim
        ...
        // 2- loop'un icerisinde herbir eleman geldiginde hangi islem yapacaksiniz
        // 3- hangi array veya collection'dan elemanlar gelecek
        toplam = 0;

        for (int each: arr // arr'ye git herbir int elemani bana getir
             ) {
            if (each > 5){
                toplam += each;
            }
